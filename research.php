			...
			<div id="contents">
				...
				<div id="events">
					...
					<ul>
						...
						<li>
							<img src="images/research/thermal_structure.png" alt="Img" height="200" width="180">
							<div>
								<h4>Thermal structure of subduction zones</h4>
								<p>
						...
						<li>
							<img src="images/research/geodynamics101.png" alt="Img" height="200" width="180">
							<div>
								<h4>Geodynamics 101</h4>
								<p>
						...
						<li>
							<img src="images/research/splay_faults.png" alt="Img" height="200" width="180">
							<div>
								<h4>Rupture on splay faults & tsunamis</h4>
								<p>
						...
						<li>
							<div>
								<h4>3D coupling of earthquakes and tsunamis</h4>
								<p>
									In a project led by Aniko Wirp (LMU Munich, Germany), we use the output of a geodynamic seismic cycle model (<em>Van Zelst et al., 2019 JGR</em>) as input for a 3D dynamic rupture model and coupled 2D tsunami inundation and propagation model to investigate how variations in hypocenter location in linked models impacts rupture dynamics, seafloor uplift, and tsunami generation, propagation, and inundation. The results of these physics-based linked dynamic rupture and tsunami scenarios generate new insights in seismic and tsunami hazards. 
								</p>
							</div>
						</li>
						...
						<li>
							<div>
								<h4>Subduction dynamics and seismicity</h4>
								<p>
						...
						<li>
							<img src="images/research/tsunami1.png" alt="Img" height="200" width="180">
							<div>
								<h4>Tectonics & tsunamigenesis</h4>
								<p>
									We complement a global earthquake database that contains subduction zone characteristics (<em>Heuret et al., 2011</em>) with tsunami data. We analyse the database using both bi- and multivariate statistical methods to identify tectonic parameters that affect tsunamigenesis. 
								</p>
							</div>
						</li>
					...
					<a href="research1.php"><h1>Completed projects</h1></a>
				</div>
			</div>
